...
exports.TablesModule = TablesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [tables_repository_1.TablesRepository, tables_service_1.TablesService],
        exports: [tables_repository_1.TablesRepository, tables_service_1.TablesService]
    })
], TablesModule);
